...
function Card({ dica }) {
  ...
  return (
    <div
      ...
      style={{
        opacity: visible ? 1 : 0,
        transform: visible ? "translateY(20px)" : "translateY(40px)",
    ...
    >
      <div className="card shadow-sm h-100 border-0 dica-card">
        <div className="card-body text-center">
          ...
          <i className={`bi ${dica.icone}`} 
             style={{ fontSize: "32px", color: "#455c06" }}></i>
  ...
  return (
    <div className="row">
      ...
      <div className="col-10 p-4">
        ...
        <div className="mt-5 p-4 rounded text-white text-center"
